...
class Profile extends React.Component {
  componentWillMount() {
    this.props.onLoad(Promise.all([
      ...
      agent.Articles.getByAuthor(this.props.match.params.username)
    ]));
  }
          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-md-10 offset-md-1">
                ...
                { profile.image &&
                  <img src={`${AVATAR_URL}/${profile.image}`} className="user-image-lg d-flex mx-auto my-3" alt={profile.username} />
                }
